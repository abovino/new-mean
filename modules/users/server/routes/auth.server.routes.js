...
module.exports = function (app) {
  ...
  app.route('http://localhost:3000/api/auth/fitbit/callback').get(users.oauthCall('fitbit', {
    scope: ['profile']
  }));
  app.route('http://localhost:3000/api/auth/fitbit/callback').get(users.oauthCallback('fitbit'));
};
